...
/*   Updated: 2021/07/31 21:59:04 by tvachera         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Form::Form(): m_name("default_form"), m_signed(false), m_gexec(GRADE_MIN), m_gsign(GRADE_MIN)
{
}

Form::Form( const Form & src ): m_name(src.m_name), m_signed(false), m_gexec(src.m_gexec), m_gsign(src.m_gsign)
{
}

Form::Form( std::string const name, size_t const gsign, size_t const gexec): m_name(name), m_signed(false), m_gexec(gexec), m_gsign(gsign)
{
