...
/*   Updated: 2021/07/27 09:52:17 by tvachera         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << C_GREEN << "ScavTrap's copy constructor called (" << m_name << ")" << C_RESET << std::endl;
}
...
ScavTrap::ScavTrap(std::string name): ClapTrap(name), m_guard_mode(false)
{
	...
	m_energy = 50;
	m_damage = 20;
	std::cout << C_GREEN << "ScavTrap's string constructor called (" << m_name << ")" << C_RESET << std::endl;
}
...
ScavTrap::~ScavTrap()
{
	std::cout << C_RED << "ScavTrap's destructor called (" << m_name << ")" << C_RESET << std::endl;
}
